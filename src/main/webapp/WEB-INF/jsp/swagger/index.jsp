...
<div id='header'>
  <div class="swagger-ui-wrap">
    <a id="logo" href="javascript:;"><img class="logo__img" alt="swagger" height="30" width="30" src="/swagger/images/logo_small.png" /><span class="logo__title">API debug</span></a>
